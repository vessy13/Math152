  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="" width=100 height=100 alt="Vesandro Tandoc" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://tvesandro@gmail.com" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Vesandro Tandoc</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+63 9168696421</h4>
		<h4 style="font-family:'typo' ">tvesandro@gmail.com</h4>
		<h4 style="font-family:'typo' ">Vest Site</h4></div></div>
		</p>
      </div>
